/*
  Im_CatmanYT's profile on Random Rants + about page
*/
...
const ALT_NAME = "Username in Scratch: Im_CatmanYT (he/him)"; //MOP3000 doesn't prefer using real name so use scratch name.
